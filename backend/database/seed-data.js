...
const BANNERS = [
  { title: 'Bộ Sưu Tập Mới', subtitle: 'Khám phá phong cách của bạn', image: '/img-placeholder?text=Banner+1&w=1920&h=600', link: '/collections/all', sort_order: 1 },
  { title: 'Áo Thun Relaxed Fit', subtitle: 'Thoải mái, phong cách, cá tính', image: '/img-placeholder?text=Banner+2&w=1920&h=600', link: '/collections/ao-thun', sort_order: 2 },
  { title: 'Áo Hoodie & Sweater', subtitle: 'Ấm áp và thời trang', image: '/img-placeholder?text=Banner+3&w=1920&h=600', link: '/collections/ao-hoodie', sort_order: 3 },
  { title: 'Phụ Kiện - Túi Canvas', subtitle: 'Hoàn thiện phong cách của bạn', image: '/img-placeholder?text=Banner+4&w=1920&h=600', link: '/collections/tui-canvas', sort_order: 4 },
];
